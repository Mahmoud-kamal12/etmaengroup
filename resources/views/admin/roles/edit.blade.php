        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">تعديل صلاحيه</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row product-adding">
        <div class="col-xl-12">
            <div class="card">
                ...
                @isset($role)
                <div class="card-body">
                    <form class="card" action="{{url(route('admin/roles/update', $role->id))}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    @isset($permissions)
                                        ...
                                        <div class="form-group col-sm-3">
                                            <input class="form-check-input checkbox-on-change" type="checkbox" name="permission_id[]" value="{{$permission->id}}" id="basic_{{$permission->id}}" {{ $role->permissionHas($permission->id) ? 'checked' : '' }}>
