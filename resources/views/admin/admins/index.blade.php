                ...
                <div class="card-body">
                    ...
                    <div class="btn-popup pull-right">
                        <button class="btn btn-primary btn-xs mt-1" type="button">
                            <a href="{{route('admins/create')}}" style="text-decoration:none;color:white;">
                                اضافه
                            </a>
                        </button>
                    </div>
                    ...
                    <div class="card-body vendor-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-warning btn-xs mt-1" type="button">
                                            <a href="{{route('admins/role', $admin->id)}}" style="text-decoration:none;color:white;">
                        ...
                        <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                            Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Admin::where('is_teacher', 0)->count()}}</span> entries
                        </div>
                                    ...
                                    `
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- role row -->
                                                                <button class="btn btn-warning btn-xs mt-1" type="button">
                                                                    <a href="${data[i].urlRouteRole}" style="text-decoration:none;color:white;">
                                                                        <i class="fas fa-edit" style="color:white;"></i>
                                                                    </a>
                                                                </button>
                                                            <!-- end role row -->
