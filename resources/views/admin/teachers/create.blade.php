            ...
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">
                        <a style="text-decoration:none;color:black;" href="{{url(route('admin/teachers/index'))}}">
                            المدربين
                        </a>
                    </li>
                    <li class="breadcrumb-item active">اضافه مدرب</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row product-adding">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="card" action="{{url(route('admin/teachers/store'))}}" method="post" enctype="multipart/form-data">
