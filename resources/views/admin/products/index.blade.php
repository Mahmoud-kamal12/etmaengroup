                ...
                <div class="card-body">
                    ...
                    <div class="btn-popup pull-right">
                        <button class="btn btn-primary btn-xs mt-1" type="button">
                            <a href="{{route('admin/products/create')}}" style="text-decoration:none;color:white;">
                                اضافه
                            </a>
                        </button>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="ml-2 d-flex">
                                            <img src="{{asset($product->photo)}}" alt="" class="img-fluid img-50 rounded-circle blur-up lazyloaded">
                                        </div>
                                    </td>
                                    <td>{{$product->type}}</td>
                                    <td>{{$product->price}}</td>
                                    ...
                                    <td> 
                                        ...
                                        <!-- edit row -->
                                            <button class="btn btn-success btn-xs" type="button">
                                                <a href="{{route('admin/lessons/index', $product->id)}}" style="text-decoration:none;color:white;">
                                        ...
                                        <!-- edit row -->
                                            <button class="btn btn-warning btn-xs" type="button">
                                                <a href="{{route('admin/products/edit', $product->id)}}" style="text-decoration:none;color:white;">
                                        ...
                                        <!-- activate row -->
                                        @include('admin.products.activate')
                                        <!-- end activate row -->
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                                            ...
                                            `
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- edit row -->
                                                            <button class="btn btn-success btn-xs" type="button">
                                                                <a href="${data[i].urlRouteLessons}" style="text-decoration:none;color:white;">
                                                                    <i class="fas fa-file-upload"></i>
                                                                </a>
                                                            </button>
                                                        <!-- end edit row -->
                            ...
                            document.getElementById("productsRecords").innerHTML += records
                            length += data.length
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.length > 0) {
                    ...
                    document.getElementById("productsRecords").style.display = null
                    document.getElementById("productsRecords").innerHTML = records
                    $('#load_more_button').remove();
                    ...
                    length = data.length
                    showItems.innerHTML = Number(length)
                    document.getElementById("productsRecords").style.display = 'none'
                    let btnNoData = `<button type="button" name="load_more_button" class="w-auto btn btn-primary form-control px-5" id="load_more_button_remove">No Data</button>`
                    document.getElementById("load_more").innerHTML = btnNoData
                }
            }
